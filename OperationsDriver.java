public class OperationsDriver{
    ...
    public static void main(String[] args) {
        ...
        int[] counter = new int[]{1,2,1,1,1,2,3,4,5};
        ...
        System.out.println("New array: {1,2,1,1,1,2,3,4,5}");
        System.out.println("The count for 1 should return 4");
        System.out.println("The count returned: " + Operations.count(counter, 1));
        System.out.println("The count for 2 should return 2");
        System.out.println("The count returned: " + Operations.count(counter, 2));
